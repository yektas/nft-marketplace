...
export const Footer = (props: Props) => {
  return (
    <footer className="p-10 text-center bg-primary">
      <div>
        <svg
          width="50"
          height="50"
      ...
      <div>
        <div className="flex justify-center mt-5 space-x-6">
          <a
            ...
            rel="noreferrer"
            aria-label="Twitter"
            className="inline p-2 transition-all duration-200 ease-in-out bg-gray-800 rounded-full shadow-xl fill-current hover:-translate-y-1"
          >
